...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$soap$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/soap/index.js [app-rsc] (ecmascript)");
...
function extractSessionId(response) {
    ...
    if (Array.isArray(response)) {
        for (const entry of response){
            const value = extractSessionId(entry);
    ...
    if (typeof response === 'object') {
        ...
        return typeof record.result === 'string' && record.result || typeof record.return === 'string' && record.return || typeof record.sessionId === 'string' && record.sessionId;
    }
    return undefined;
}
async function getSoapClient() {
    if (!soapClientPromise) {
        soapClientPromise = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$soap$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClientAsync"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].ETAPESTRY_WSDL_URL).then(async (client)=>{
            try {
                const apiKeyLogin = client.apiKeyLoginAsync;
                if (!apiKeyLogin) {
                    throw new Error('eTapestry client does not expose apiKeyLogin.');
                }
                const [loginResponse] = await apiKeyLogin({
                    String_1: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].ETAPESTRY_LOGIN_ID,
                    String_2: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].ETAPESTRY_API_KEY
                });
                const sessionId = extractSessionId(loginResponse);
                if (!sessionId) {
                    throw new Error('eTapestry apiKeyLogin did not return a session id.');
                }
...
async function executeQuery(client, request) {
    ...
    if (typeof queryClient.getExistingQueryResultsAsync === 'function') {
        return queryClient.getExistingQueryResultsAsync.call(queryClient, args);
    }
    return new Promise((resolve, reject)=>{
        if (typeof queryClient.getExistingQueryResults !== 'function') {
            reject(new Error('getExistingQueryResults is not available on the configured SOAP client.'));
            return;
        }
        queryClient.getExistingQueryResults(args, (error, result, raw, soapHeader)=>{
            if (error) {
                reject(error);
                return;
            }
...
async function fetchPledges(range) {
    ...
    while(start < 5000){
        const [response] = await executeQuery(client, {
            query: {
                category: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].ETAPESTRY_QUERY_CATEGORY,
                name: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].ETAPESTRY_QUERY_NAME
            },
            start,
            count: pageSize
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__564ccb74._.js.map