module.exports = [
"[project]/node_modules/xpath/xpath.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ // non-node wrapper
var xpath = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : exports;
(function(exports1) {
    "use strict";
    // functional helpers
    function curry(func) {
        var slice = Array.prototype.slice, totalargs = func.length, partial = function(args, fn1) {
            return function() {
    ...
    function FunctionCall(fn1, args) {
        if (arguments.length > 0) {
            this.init(fn1, args);
        }
    }
    ...
    (function() {
        ...
        /** Converts native JavaScript types to their XPath library equivalent */ function convertValue(value) {
        ...
        function makeFunctionResolverFromFunction(func) {
            return {
                getFunction: function(name1, namespace) {
        ...
        function makeVariableResolverFromFunction(func) {
            return {
                getVariable: function(name1, namespace) {
...
//# sourceMappingURL=node_modules_xpath_xpath_39eab75e.js.map