...
const authOptions = {
    ...
    callbacks: {
        async signIn ({ user }) {
            ...
            if (!domain || domain.toLowerCase() !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].ALLOWED_EMAIL_DOMAIN.toLowerCase()) {
        ...
        async signIn ({ user }) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
                ...
                data: {
                    ...
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].ADMIN_EMAILS.includes(user.email.toLowerCase()) ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4092704b._.js.map