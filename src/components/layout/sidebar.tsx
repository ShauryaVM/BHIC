...
import { Activity, CalendarDays, Gauge, Lightbulb, MessageSquare, Settings, Users2, X } from "lucide-react";
...
function NavigationSections({ pathname, isAdmin, showAdminNotice, onNavClick, onDismissNotice }: NavigationSectionsProps) {
  return (
    <>
